...
export default function App() {
  const { elapsed, isRunning, laps, start, pause, reset, recordLap, deleteLap, resumeFromLap } = useStopwatch()
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4">
      <div className="w-full max-w-3xl">
        ...
        {/* Laps Section */}
        <LapsSection laps={laps} onDeleteLap={deleteLap} onResumeLap={resumeFromLap} isStopwatchRunning={isRunning} />
      </div>
    </div>
  )
}